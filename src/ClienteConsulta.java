...
public class ClienteConsulta extends Frame implements WindowListener, ActionListener 
{
	...
	public void rellenarTextArea(Connection con, TextArea t)
	{
		...
		try {
			...
			Log4JCoreJava objLog4JCoreJavaSample = new Log4JCoreJava();
			  objLog4JCoreJavaSample.callMeInAppWarn("Se entro a ConsultaCliente");
			while (rs.next()) 
			{
				if(t.getText().length()==0)
				{
					t.setText(rs.getInt("DNICliente")+
