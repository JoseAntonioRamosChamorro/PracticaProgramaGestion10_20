...
public class ClienteBaja extends Frame implements WindowListener, ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(objetoPulsado.equals(btnSi))
		{
			...
			Connection con = conectar(); 
			// Borrar
			String[] DNI=choCliente.getSelectedItem().split("-");
	...
	public int borrar(Connection con, int DNI)
	{
		int respuesta = 0;
		String sql = "DELETE FROM Clientes WHERE DNICliente = " + DNI;
